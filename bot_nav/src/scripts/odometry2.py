...
#############################################################################
    ...
    #############################################################################
        ...
        self.ticks_meter = float(rospy.get_param('ticks_meter', 183))  # The number of wheel encoder ticks per meter of travel
        self.base_width = float(rospy.get_param('~base_width', 0.385)) # The wheel base width in meters
        
        self.base_frame_id = rospy.get_param('~base_frame_id','chassis') # the name of the base frame of the robot
